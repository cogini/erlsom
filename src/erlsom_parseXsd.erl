...
-include("erlsom.hrl"). %% the record definitions
  ...
  #model{tps = [
    ...
    #type{nm  = schemaType,
          ...
          atts = [#att{nm = targetNamespace, nr = 3, opt = true, tp = char},
                  #att{nm = elementFormDefault, nr = 4, opt = true, tp = char},
                  #att{nm = attributeFormDefault, nr = 5, opt = true, tp = char},
                  #att{nm = blockDefault, nr = 6, opt = true, tp = char},
                  #att{nm = finalDefault, nr = 7, opt = true, tp = char},
                  #att{nm = version, nr = 8, opt = true, tp = char},
                  #att{nm = id, nr = 9, opt = true, tp = char}],
          nr = 10},
    ...
    #type{nm  = importType,
          ...
          atts = [#att{nm = id, nr = 3, opt = true, tp = char},
                  ...
                  #att{nm = schemaLocation, nr = 5, opt = true, tp = char}],
          nr = 5},
    ...
    #type{nm  = includeType,
          els = [#el{alts = [#alt{tag = 'xsd:annotation', tp = 'annotationType'}],
                     ...
                     nr = 5}],
          atts = [#att{nm = id, nr = 3, opt = true, tp = char},
                  #att{nm = schemaLocation, nr = 4, opt = false, tp = char}],
          nr = 4},
    ...
    #type{nm = globalElementType,
          ...
          atts = [#att{nm = name, nr = 3, opt = false, tp = ascii},
                  #att{nm = type, nr = 4, opt = true, tp = qname},
                  #att{nm = default, nr = 5, opt = true, tp = char},
                  #att{nm = fixed, nr = 6, opt = true, tp = char},
                  #att{nm = id, nr = 7, opt = true, tp = char},
                  #att{nm = abstract, nr = 8, opt = true, tp = bool},
                  #att{nm = substitutionGroup, nr = 9, opt = true, tp = qname},
                  #att{nm = final, nr = 10, opt = true, tp = char},
                  #att{nm = nillable, nr = 11, opt = true, tp = bool}],
          nr = 13},
    ...
    #type{nm = localElementType,
          ...
          els = [#el{alts = [#alt{tag = 'xsd:annotation', tp = 'annotationType'}],
                     ...
                     mx = unbound,
                     nr = 14}],
          atts = [#att{nm = name, nr = 3, opt = true, tp = ascii},
                  #att{nm = type, nr = 4, opt = true, tp = qname},
                  #att{nm = default, nr = 5, opt = true, tp = char},
                  #att{nm = fixed, nr = 6, opt = true, tp = char},
                  #att{nm = form, nr = 7, opt = true, tp = char},
                  #att{nm = ref, nr = 8, opt = true, tp = qname},
                  #att{nm = minOccurs, nr = 9, opt = true, tp = char},
                  #att{nm = maxOccurs, nr = 10, opt = true, tp = char},
                  #att{nm = nillable, nr = 11, opt = true, tp = bool}],
          nr = 13},
    ...
    #type{nm = globalComplexTypeType,
          ...
          els = [#el{alts = [#alt{tag = 'xsd:annotation', tp = 'annotationType'}],
                     ...
                     nr = 12}],
          atts = [#att{nm = name, nr = 3, opt = false, tp = ascii},
                  #att{nm = final, nr = 4, opt = true, tp = char},
                  #att{nm = abstract, nr = 5, opt = true, tp = bool},
                  #att{nm = block, nr = 6, opt = true, tp = char},
                  #att{nm = mixed, nr = 7, opt = true, tp = bool},
                  #att{nm = id, nr = 8, opt = true, tp = char}],
          nr = 11},
    ...
    #type{nm = simpleContentType,
          ...
          els = [#el{alts = [#alt{tag = 'xsd:annotation', tp = 'annotationType'}],
                     ...
                     mx = 1,
                     nr = 4}],
          atts = [#att{nm = id, nr = 5, opt = true, tp = char}],
          nr = 4},
    ...
    #type{nm = complexContentType,
          ...
          els = [#el{alts = [#alt{tag = 'xsd:annotation', tp = 'annotationType'}],
                     ...
                     mx = 1,
                     nr = 4}],
          atts = [#att{nm = mixed, nr = 5, opt = true, tp = bool}],
          nr = 4},
    ...
    #type{nm = extensionType,
          ...
          atts = [#att{nm = base, nr = 3, opt = false, tp = qname}],
          nr = 5},
    ...
    #type{nm = restrictionType,
          ...
          atts = [#att{nm = base, nr = 7, opt = false, tp = qname}],
          nr = 6},
    ...
    #type{nm = groupRefType,
          anyAttr = AnyAttr,
          els = [],
          atts = [#att{nm = ref, nr = 3, opt = false, tp = qname},
                  #att{nm = minOccurs, nr = 4, opt = true, tp = char},
                  #att{nm = maxOccurs, nr = 5, opt = true, tp = char}],
          nr = 4},
    ...
    #type{nm = globalAttributeType,
          ...
          atts = [#att{nm = name, nr = 3, opt = false, tp = ascii},
                  #att{nm = type, nr = 4, opt = true, tp = qname},
                  #att{nm = use, nr = 5, opt = true, tp = char},
                  #att{nm = fixed, nr = 6, opt = true, tp = char},
    ...
    #type{nm = localAttributeType,
          ...
          atts = [#att{nm = name, nr = 3, opt = true, tp = ascii},
                  ...
                  #att{nm = fixed, nr = 7, opt = true, tp = char},
                  #att{nm = form, nr = 8, opt = true, tp = char},
                  #att{nm = default, nr = 9, opt = true, tp = char}],
          nr = 9},
    ...
    #type{nm = choiceType,
          ...
          els = [#el{alts = [#alt{tag = 'xsd:annotation', tp = 'annotationType'}],
                     ...
                     mx = unbound,
                     nr = 7}],
          atts = [#att{nm = id, nr = 6, opt = true, tp = char}, %% order of fields is a bit strange
                  #att{nm = minOccurs, nr = 4, opt = true, tp = char},
                  #att{nm = maxOccurs, nr = 5, opt = true, tp = char}],
          nr = 6},
    ...
    #type{nm = sequenceType,
          ...
          els = [#el{alts = [#alt{tag = 'xsd:annotation', tp = 'annotationType'}],
                     ...
                     mx = unbound,
                     nr = 4}],
          atts = [#att{nm = minOccurs, nr = 5, opt = true, tp = char},
                  #att{nm = maxOccurs, nr = 6, opt = true, tp = char}],
          nr = 5},
    ...
    #type{nm = anyType,
          ...
          els = [#el{alts = [#alt{tag = '#any', tp = any, nxt = [], anyInfo = AnyInfo}],
                     ...
                     mx = unbound,
                     nr = 3}],
          atts = [#att{nm = minOccurs, nr = 4, opt = true, tp = char},
                  #att{nm = maxOccurs, nr = 5, opt = true, tp = char},
                  #att{nm = namespace, nr = 6, opt = true, tp = char},
                  #att{nm = processContents, nr = 7, opt = true, tp = char}],
          nr = 6},
    ...
    #type{nm = attributeGroupDefType,
          ...
          els = [#el{alts = [#alt{tag = 'xsd:annotation', tp = 'annotationType'}],
                     ...
                     nr = 7}],
          atts = [#att{nm = id, nr = 3, opt = true, tp = char},
                  #att{nm = name, nr = 4, opt = false, tp = ascii}],
          nr = 6},
