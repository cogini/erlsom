...
%% @doc Writes record defintions, taking a 'model' (from erlsom_compile) as
%% input.
...
-spec writeHrlFile(binary(), string(), [#ns{}]) -> iolist().
...
-spec writeXsdHrlFile(binary(), [erlsom:compile_option()]) -> iolist().
